...
- [ ] Run full typecheck, tests, production build, live route/API smoke tests, and publish the direct-operation release. Local direct dashboard API returns HTTP 200 without auth; the final Vercel check must follow the latest middleware fix.
