...
- [ ] Diagnose the reported blank or non-working browser experience on both egyptbjj.vercel.app and the managed fallback domain, then verify the actual rendered UI.
