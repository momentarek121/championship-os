...
- [x] Refactor and verify the operations code with tests and responsive UI checks, then push the clean release to GitHub and Vercel. TypeScript, production build, and 63 Vitest tests pass; commit `a0c864c` is pushed to GitHub; primary Vercel routes and JavaScript asset delivery return HTTP 200.
