...
export const users = mysqlTable("users", {
  ...
  role: mysqlEnum("role", ["user", "admin", "organizer", "registration_staff", "weighin_staff", "referee", "mat_manager", "athlete"]).default("user").notNull(),
...
export const tournaments = mysqlTable("tournaments", {
  ...
  organizationName: varchar("organizationName", { length: 160 }).default("Championship OS").notNull(),
...
export const registrations = mysqlTable("registrations", {
  ...
  weighInNotes: text("weighInNotes"),
