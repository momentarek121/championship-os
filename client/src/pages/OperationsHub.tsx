...
const tools = [
  ...
  { href: "/import", icon: ClipboardList, en: "Import athlete roster", ar: "استيراد قائمة اللاعبين", detailEn: "Excel, PDF, or CSV upload with automatic placement", detailAr: "رفع Excel أو PDF أو CSV مع تسكين تلقائي" },
